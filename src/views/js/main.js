...
var pizzaElementGenerator = function(i) {
  ...
  // Optimization: used a compressed version of the original file but with same dimensions
...
var resizePizzas = function(size) {
  ...
  // Use document.getElementById instead of document.querrySelectorAll to boost performance
  ...
  function determineDx (elem, size) {
	...
	// Optimization: getElementById is faster 
  ...
  function changePizzaSizes(size) {
    // Optimization: create randomPizzaContainer array variable that references all elements with classname randomPizzaContainer
	var randomPizzaContainer = document.getElementsByClassName("randomPizzaContainer");
	// Optimization: Determine the length of the randomPizzaContainer array
	var randomPizzaContainerLength = randomPizzaContainer.length;
	// Optimization: Pull dx and newwidth from for loop to prevent forced synchronous layout
...
function updatePositions() {
  ...
  // Optimization: use getElementsByClassName instead of querySelectorAll to improve perfomance
  var items = document.getElementsByClassName('mover');
  // Optimization: Define myScroll variable and pull it out of the for loop since it is constant
  var myScroll = document.body.scrollTop / 1250;
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin(myScroll + (i % 5));
...
// Optimization: 30 pizzas instead of 200 to improve performance
